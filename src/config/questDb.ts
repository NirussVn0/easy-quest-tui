export const QUEST_DB: Record<string, { name: string; duration: number }> = {
	...
	'1438202046804136028': { name: 'Microsoft Edge - Your AI Browser', duration: 29 },
	'1428092429030129755': { name: 'Chainsaw Man \u2013 The Movie: Reze Arc', duration: 61 },
